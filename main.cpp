/**
 * Laboratory #8 - CSCI2421 - Summer 2021
 * File: main.cpp
 */
...
#include "domain/StreamingService.h"
...
int displayMenu(){
    ...
    cout << "      3) Sort the Movies by Title   " << endl;
    ...
    while (option>=0){
        ...
        switch (option) {
            ...
            case 3: //Sort movies.
                cout<<endl<<endl;
                cout << string(120,'*') << endl;
                cout << "Sorting Movies by Title" << endl;
                myService->sortMovies();
                cout << "--------------------     DONE!    ----------------------" << endl;
                break;
